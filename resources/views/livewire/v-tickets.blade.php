   ...
   @endif
    ...
    <table class="table table-striped table-sm" style="margin-top:10px;">
        ...
        @endif>
                ...
                <td>{{$row->type}}</td>
                <td>{{$row->status}}</td>
                <td>{{ $this->vcart($row->id)}}</td>
                <td>@if ($row->forn_type != NULL && $row->Forn_id != NULL)
                ...
                @endcan
                @can('print_vt')
                <button  wire:click="print({{ $row->id }})" class="btn btn-warning btn-sm"><i class="fa fa-print" aria-hidden="true"></i></button>
                @endcan
                </td>
            </tr>
        @endforeach
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <select wire:model.lazy="forn_type" class="form-control" aria-label="Default select example">
                                <option value="">--Selectioner l'ouvrier--</option>
            ...
            <div class="modal-content">
               ...
               <div class="modal-body">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Nombre de billets dans le paquet</label>
