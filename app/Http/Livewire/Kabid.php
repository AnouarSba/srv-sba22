...
use App\Models\Kabid as kab;
use App\Models\User;
use Livewire\Component;
use Livewire\WithPagination;
class Kabid extends Component
{
    use WithFileUploads;
    ...
    public function store()
    {
        $validatedDate = $this->validate([
            'name' => 'required',
            'email' => 'required|email|unique:kabids',
    ...
    public function printcart($id){
        return redirect()->to("/printauthcart/$id");
    }
    public function changecart($id){return redirect()->to("/changeauthcart/$id");}
